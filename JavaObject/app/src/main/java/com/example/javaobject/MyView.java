...
//        mTextHeight = fontMetrics.bottom;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PointGraphic p = new PointGraphic(3,5, Color.BLUE);
        p.draw(canvas);

        PointGraphic p1 = new PointGraphic(310,320, Color.RED);
        p1.draw(canvas);

        PointGraphic p2 = new PointGraphic(3,630, Color.BLUE);
        p2.draw(canvas);

        PointGraphic p3 = new PointGraphic(310,940, Color.RED);
        p3.draw(canvas);
